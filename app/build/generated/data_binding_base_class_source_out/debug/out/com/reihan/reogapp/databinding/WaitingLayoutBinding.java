...
public final class WaitingLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private WaitingLayoutBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView,
  ...
  @NonNull
  public static WaitingLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static WaitingLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.waiting_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static WaitingLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new WaitingLayoutBinding((ConstraintLayout) rootView, imageView, okButton, successDesc,
          successText);
    }
